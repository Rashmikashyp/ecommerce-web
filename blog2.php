      ...
      <div class="container">
        <div class="row d-flex flex-wrap">
          <article class="col-md-4 post-item">
            ...
            <div class="post-content d-flex">
              ...
              <div class="post-header">
                <h3 class="post-title">
            top 10 casual look ideas to dress up your kia
                </h3>
          ...
          <article class="col-md-4 post-item">
            ...
            <div class="post-content d-flex">
              ...
              <div class="post-header">
                <h3 class="post-title">
                  Latest trends of wearing street wears suprem
                </h3>
        ...
        <nav class="navigation paging-navigation text-center padding-medium" role="navigation">
          <div class="pagination loop-pagination d-flex justify-content-center">
            ...
            <span aria-current="page" class="page-numbers "> <a href="blog.php">1</a></span>
            <a class="page-numbers current" href="blog2.php">2</a>
